...
def run_multihead_self_attention_with_rope(
    ...
    attn = MultiHeadSelfAttentionRoPE(d_model, num_heads, max_seq_len, theta)
    attn.load_state_dict({
...
def run_transformer_block(
    ...
    res = transformer.load_state_dict({
...
def run_transformer_lm(
    ...
    """
    model = TransformerLM(vocab_size, d_model, num_heads, d_ff, num_layers, context_length, rope_theta)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    vocab, merges = trainer.train(input_path, special_tokens, **kwargs)

    # vocab, merge = train_bpe(input_path, vocab_size, special_tokens, **kwargs)
    return vocab, merge
